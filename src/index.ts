...
import {NativeSettings} from './plugins/settings';
import {PusherInit} from './plugins/pushnotification';
import {SBoxInviteFriends} from './plugins/sboxinvitefriends';
...
window['IonicNative'] = {
  ...
  PusherInit: PusherInit,
  SBoxInviteFriends: SBoxInviteFriends
};
